...
class BCELoss(Module):
    ...
    def forward(self, predictions: Tensor, targets: Tensor) -> Tensor:
        ...
        pred_clamped = Tensor(pred_clamped_data, requires_grad=predictions.requires_grad)
        ...
        log_one_minus_pred = Tensor(log_one_minus_pred_data, requires_grad=pred_clamped.requires_grad)
...
class HuberLoss(Module):
    ...
    def forward(self, predictions: Tensor, targets: Tensor) -> Tensor:
        ...
        loss = Tensor(loss_data, requires_grad=(predictions.requires_grad or targets.requires_grad))
